export const translations = {
    en: {
        ...
        items: [
            ...
            { title: "Personal Blog", description: "A blog built with Next.js and MDX" },
            { title: "Analytics Dashboard", description: "Real-time data visualization panel" },
        ],
    ...
    es: {
        ...
        items: [
            { title: "App de E-commerce", description: "Una plataforma de compras en línea" },
